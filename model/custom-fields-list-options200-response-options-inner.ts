...
// @ts-ignore
import type { CustomFieldsListOptions200ResponseOptionsInnerMeta } from './custom-fields-list-options200-response-options-inner-meta';

export interface CustomFieldsListOptions200ResponseOptionsInner {
    /**
     ...
     */
    'value': string;
    'meta'?: CustomFieldsListOptions200ResponseOptionsInnerMeta;
}
