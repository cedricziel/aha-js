...
// @ts-ignore
import type { CustomFieldOptionCreateRequestCustomFieldOption } from './custom-field-option-create-request-custom-field-option';

export interface CustomFieldOptionCreateRequest {
    'custom_field_option': CustomFieldOptionCreateRequestCustomFieldOption;
}
