...
export interface CustomFieldDefinition {
    ...
    'key': string;
    /**
     * Type of the custom field (e.g., CustomFieldDefinitions::SelectConstant)
     */
    'type': string;
    /**
     * Type of record this custom field can be applied to
     */
    'custom_fieldable_type': string;
    /**
     * Internal name for the custom field
     */
