...
// @ts-ignore
import type { CustomFieldDefinition } from './custom-field-definition';

export interface CustomFieldsListAll200Response {
    'custom_field_definitions'?: Array<CustomFieldDefinition>;
}
