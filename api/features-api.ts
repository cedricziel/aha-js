...
export const FeaturesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        featuresList: async (q?: string, updatedSince?: string, tag?: string, assignedToUser?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const FeaturesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async featuresList(q?: string, updatedSince?: string, tag?: string, assignedToUser?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeaturesListResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.featuresList(q, updatedSince, tag, assignedToUser, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const FeaturesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        featuresList(requestParameters: FeaturesApiFeaturesListRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<FeaturesListResponse> {
            return localVarFp.featuresList(requestParameters.q, requestParameters.updatedSince, requestParameters.tag, requestParameters.assignedToUser, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class FeaturesApi extends BaseAPI implements FeaturesApiInterface {
    ...
    public featuresList(requestParameters: FeaturesApiFeaturesListRequest = {}, options?: RawAxiosRequestConfig) {
        return FeaturesApiFp(this.configuration).featuresList(requestParameters.q, requestParameters.updatedSince, requestParameters.tag, requestParameters.assignedToUser, options).then((request) => request(this.axios, this.basePath));
    }
}
