...
|------------- | ------------- | -------------|
|[**initiativesGet**](#initiativesget) | **GET** /initiatives | List initiatives|
|[**initiativesIdGet**](#initiativesidget) | **GET** /initiatives/{id} | Get a specific initiative|
...
|[**productsProductIdInitiativesPost**](#productsproductidinitiativespost) | **POST** /products/{product_id}/initiatives | Create an initiative|

# **initiativesGet**
> InitiativesListResponse initiativesGet()
...
# **initiativesIdGet**
> InitiativeResponse initiativesIdGet()
...
const { status, data } = await apiInstance.initiativesIdGet(
    id
);
```
...
# **productsProductIdInitiativesPost**
> InitiativeResponse productsProductIdInitiativesPost(initiativeCreateRequest)
...
const { status, data } = await apiInstance.productsProductIdInitiativesPost(
    productId,
    initiativeCreateRequest
);
```
