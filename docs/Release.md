...
**workflowStatusTimes** | [**Array&lt;IdeaResponseIdeaWorkflowStatusTimesInner&gt;**](IdeaResponseIdeaWorkflowStatusTimesInner.md) | Workflow status times for the release | [optional] [default to undefined]
